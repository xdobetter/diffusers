set -v
 ...
 # s1_girl_character_lora_v1
 export project_name="s1_girl_character_lora_v1" # !modify
 ...
 # s2_girl_character_lora_v1
 export project_name="s2_girl_character_lora_v1" # !modify
 export MODEL_NAME="runwayml/stable-diffusion-v1-5"
...
# s10_girl_character_lora_v1
 export project_name="s10_girl_character_lora_v1" # !modify
 export MODEL_NAME="runwayml/stable-diffusion-v1-5"
...
# s12_girl_character_lora_v1
 export project_name="s12_girl_character_lora_v1" # !modify
 export MODEL_NAME="runwayml/stable-diffusion-v1-5"
